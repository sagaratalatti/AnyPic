...
public class HomeListActivity extends ListActivity {
    ...
    private void makeMeRequest() {
        GraphRequest request = GraphRequest.newMeRequest(ParseFacebookUtils.getSession(),
                new GraphRequest.GraphUserCallback() {
                    @Override
                    public void onCompleted(GraphUser user, GraphResponse response) {
                        if (user != null) {
                                ...
                                public void done(List<ParseUser> objects, ParseException e) {
                                    if(e == null && objects!=null){
                                        ...
                                        for(ParseUser friend : objects){
                                            google.com.anypic.Activity followActivity = new google.com.anypic.Activity();
